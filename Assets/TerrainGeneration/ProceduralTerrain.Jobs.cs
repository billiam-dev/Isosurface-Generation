...
namespace TerrainGeneration
{
    public partial class ProceduralTerrain : MonoBehaviour
    {
        ...
        struct BuildMeshJob : IJobFor
        {
            ...
            Dictionary<int2, ushort> vertexIndexMap;

            public void Execute(int index)
            {
                chunkOrigin = terrain.WrapChunkIndex(index) * k_ChunkSize;
                densityMap = terrain.m_Chunks[index].DensityMap;
            ...
            Vector3 CalculateNormal(int3 cellIndex)
            {
                int3 samplePos = chunkOrigin + cellIndex;
